...
class GalleryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pkm.admin.galleries.index', compact('galleries', 'categories'));
    }

    public function create()
    {
        $categories = Category::galeri()->get();
        return view('pkm.admin.galleries.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pkm-admin.galleries.index')
    ...
    {
        $categories = Category::galeri()->get();
        return view('pkm.admin.galleries.edit', compact('gallery', 'categories'));
    }
