<a href="/">
    <svg class="size-16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
            ...
            <linearGradient id="bgGradientAuth" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <linearGradient id="innerGradientAuth" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#34D399;stop-opacity:0.3" />
                <stop offset="100%" style="stop-color:#10B981;stop-opacity:0.1" />
            </linearGradient>
            
            <!-- Dollar Symbol Gradient -->
            <linearGradient id="dollarGradientAuth" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <radialGradient id="glowGradientAuth" cx="50%" cy="30%" r="60%">
        ...
        <circle cx="24" cy="24" r="22" fill="url(#bgGradientAuth)" stroke="#065F46" stroke-width="1.5"/>
        
        <!-- Inner Highlight Circle -->
        <circle cx="24" cy="24" r="20" fill="url(#innerGradientAuth)"/>
        
        <!-- Glow Effect -->
        <circle cx="24" cy="24" r="18" fill="url(#glowGradientAuth)"/>
        ...
        <g transform="translate(24, 24)">
            ...
            <!-- Main Vertical Line -->
            <line x1="0" y1="-15" x2="0" y2="15" stroke="url(#dollarGradientAuth)" stroke-width="2.8" stroke-linecap="round"/>
