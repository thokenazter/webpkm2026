                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="prioritas" id="prioritas" 
                                    ...
                                    <option value="low" {{ old('prioritas', $pengumuman->prioritas) == 'low' ? 'selected' : '' }}>Rendah</option>
                                    <option value="medium" {{ old('prioritas', $pengumuman->prioritas) == 'medium' ? 'selected' : '' }}>Sedang</option>
                                    <option value="high" {{ old('prioritas', $pengumuman->prioritas) == 'high' ? 'selected' : '' }}>Tinggi</option>
                                </select>
                                @error('prioritas')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center space-x-2">
                                    <input type="color" name="warna_tema" id="warna_tema" value="{{ old('warna_tema', $pengumuman->warna_tema) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_mulai" id="tanggal_mulai" 
                                    value="{{ old('tanggal_mulai', $pengumuman->tanggal_mulai ? $pengumuman->tanggal_mulai->format('Y-m-d') : '') }}" 
