    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('per-diem-rates.update', $perDiemRate) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="pangkat_golongan" id="pangkat_golongan" 
                                    ...
                                    @foreach(['I/a', 'I/b', 'I/c', 'I/d', 'II/a', 'II/b', 'II/c', 'II/d', 'III/a', 'III/b', 'III/c', 'III/d', 'IV/a', 'IV/b', 'IV/c', 'IV/d', 'IV/e'] as $pangkat)
                                        <option value="{{ $pangkat }}" {{ old('pangkat_golongan', $perDiemRate->pangkat_golongan) == $pangkat ? 'selected' : '' }}>{{ $pangkat }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="rate_per_day" id="rate_per_day" value="{{ old('rate_per_day', $perDiemRate->rate_per_day) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_from" id="valid_from" value="{{ old('valid_from', $perDiemRate->valid_from->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_to" id="valid_to" value="{{ old('valid_to', $perDiemRate->valid_to?->format('Y-m-d')) }}" 
