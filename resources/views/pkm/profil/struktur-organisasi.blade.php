...
@section('content')
    ...
    <section class="py-12 lg:py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- Kepala Puskesmas --}}
            <div class="flex justify-center mb-8" data-animate="fade-down">
                <div
                    ...
                    <div class="mt-3 px-3 py-1.5 bg-primary-100 rounded-full inline-block">
                        <span class="text-xs font-medium text-primary-700">Ns. Makdalena Ilely, S.Kep</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {{-- Klaster 1: Manajemen --}}
                <div class="card p-6 border-l-4 border-l-blue-500 hover:shadow-lg transition-shadow" data-animate="fade-up" data-animate-delay="1">
                    ...
                    <div class="mt-4 pt-4 border-t border-neutral-100">
                        ...
                        <p class="text-sm font-medium text-neutral-700">Onalin E.E Habibuw, S.Kep.,Ns</p>
                    </div>
                </div>

                {{-- Klaster 2: KIA --}}
                <div class="card p-6 border-l-4 border-l-pink-500 hover:shadow-lg transition-shadow" data-animate="fade-up" data-animate-delay="2">
                    <div class="flex items-start gap-4">
                        <div
                    ...
                    <div class="mt-4 pt-4 border-t border-neutral-100">
                        <p class="text-xs text-neutral-400">Penanggung Jawab Klaster</p>
                        <p class="text-sm font-medium text-neutral-700">Kardioka. Silaban A.Md.Keb</p>
                    </div>
                </div>

                {{-- Klaster 3: Dewasa & Lansia --}}
                <div class="card p-6 border-l-4 border-l-amber-500 hover:shadow-lg transition-shadow" data-animate="fade-up" data-animate-delay="3">
                    <div class="flex items-start gap-4">
                        <div
                    ...
                    <div class="mt-4 pt-4 border-t border-neutral-100">
                        <p class="text-xs text-neutral-400">Penanggung Jawab Klaster</p>
                        <p class="text-sm font-medium text-neutral-700">Ns. M. Ilely.,S.Kep</p>
                    </div>
                </div>

                {{-- Klaster 4: P2P & Kesling --}}
                <div class="card p-6 border-l-4 border-l-red-500 hover:shadow-lg transition-shadow" data-animate="fade-up" data-animate-delay="4">
                    <div class="flex items-start gap-4">
                        <div
                    ...
                    <div class="mt-4 pt-4 border-t border-neutral-100">
                        <p class="text-xs text-neutral-400">Penanggung Jawab Klaster</p>
                        <p class="text-sm font-medium text-neutral-700">Jacob Galandjindjinay S.Kep, Ns</p>
                    </div>
                </div>

                {{-- Lintas Klaster --}}
                <div
                    class="card p-6 border-l-4 border-l-primary-500 hover:shadow-lg transition-shadow md:col-span-2 lg:col-span-2" data-animate="fade-up" data-animate-delay="5">
                    <div class="flex items-start gap-4">
                        <div
                    ...
                    <div class="mt-4 pt-4 border-t border-neutral-100">
                        ...
                        <p class="text-sm font-medium text-neutral-700">Amos N Djabutafuan S.Kep,.Ns</p>
                    </div>
                </div>
            </div>
            ...
            {{-- Tim Manajemen --}}
            <div class="mt-12">
                <h2 class="text-2xl font-bold text-neutral-900 mb-6 text-center" data-animate="fade-up">Tim Manajemen Puskesmas</h2>
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="card p-5 text-center hover:shadow-md transition-shadow" data-animate="fade-up" data-animate-delay="1">
                        <div
                    ...
                    <div class="card p-5 text-center hover:shadow-md transition-shadow" data-animate="fade-up" data-animate-delay="2">
                        <div
                    ...
                    <div class="card p-5 text-center hover:shadow-md transition-shadow" data-animate="fade-up" data-animate-delay="3">
                        <div
                    ...
                    <div class="card p-5 text-center hover:shadow-md transition-shadow" data-animate="fade-up" data-animate-delay="4">
                        <div
    ...
    <section class="py-12 lg:py-16 bg-neutral-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="card p-6 lg:p-8 bg-gradient-to-br from-primary-50 to-white border-primary-200" data-animate="fade-up">
                <div class="flex items-start gap-4">
                    <div
                        class="w-12 h-12 rounded-xl bg-primary-100 text-primary-600 flex items-center justify-center flex-shrink-0">
