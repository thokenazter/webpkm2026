...
@section('title', 'Puskesmas - Pusat Kesehatan Masyarakat')
...
@section('content')
    ...
    <section class="relative min-h-screen flex items-center pt-20 lg:pt-0 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                {{-- Image/Illustration --}}
                <div class="hidden lg:block relative" data-animate="fade-right">
                    <div class="relative w-full h-[500px] rounded-3xl overflow-hidden shadow-2xl border border-white/50">
                        <img src="{{ asset('images/puskesmas.png') }}" alt="Puskesmas Rawat Inap Kabalsiang Benjuring"
    ...
    <section id="layanan" class="py-16 lg:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Section Header --}}
            <div class="text-center max-w-3xl mx-auto mb-12 lg:mb-16" data-animate="fade-up">
                <span
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {{-- Klaster 1 --}}
                <a href="/klaster-1" class="group relative rounded-2xl overflow-hidden h-72 card-hover" data-animate="fade-up" data-animate-delay="1">
                    <img src="{{ asset('images/klaster1-desktop.png') }}" alt="Klaster 1"
                ...
                {{-- Klaster 2 --}}
                <a href="/klaster-2" class="group relative rounded-2xl overflow-hidden h-72 card-hover" data-animate="fade-up" data-animate-delay="2">
                    <img src="{{ asset('images/klaster2-desktop.png') }}" alt="Klaster 2"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                ...
                {{-- Klaster 3 --}}
                <a href="/klaster-3" class="group relative rounded-2xl overflow-hidden h-72 card-hover" data-animate="fade-up" data-animate-delay="3">
                    <img src="{{ asset('images/klaster3-desktop.png') }}" alt="Klaster 3"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                ...
                {{-- Klaster 4 --}}
                <a href="/klaster-4" class="group relative rounded-2xl overflow-hidden h-72 card-hover" data-animate="fade-up" data-animate-delay="4">
                    <img src="{{ asset('images/klaster4-desktop.png') }}" alt="Klaster 4"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                ...
                {{-- Lintas Klaster --}}
                <a href="/lintas-klaster" class="group relative rounded-2xl overflow-hidden h-72 md:col-span-2 card-hover" data-animate="fade-up" data-animate-delay="5">
                    <img src="{{ asset('images/lintasklaster-desktop.png') }}" alt="Lintas Klaster"
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative" data-animate="fade-right">
                    <div
                        ...
                        <img src="{{ asset('images/peta.png') }}" alt="Puskesmas Rawat Inap Kabalsiang Benjuring"
                            class="w-full h-full object-cover">
                    </div>
                ...
                <div data-animate="fade-left">
                    ...
                    <div class="relative mb-8 p-4 bg-white rounded-2xl border border-neutral-200 shadow-sm overflow-hidden">
                        {{-- Background Peta (Mobile Only) --}}
                        <div class="absolute inset-0 md:hidden">
                            <img src="{{ asset('images/peta.png') }}" alt="Peta Wilayah"
    ...
    @if(isset($latestPosts) && $latestPosts->count() > 0)
        <section class="py-16 lg:py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {{-- Section Header --}}
                <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10" data-animate="fade-up">
                    <div>
                        <span
                ...
                {{-- News Cards Grid --}}
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8" data-animate="fade-up">
                    @foreach($latestPosts as $post)
                        <article
                            ...
                            {{-- Image --}}
                            <a href="{{ route('berita.show', $post->slug) }}" class="block aspect-[16/10] overflow-hidden relative">
                            ...
                            <div class="group relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg cursor-pointer"
                                ...
                                <div
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
                                        <h4 class="font-semibold line-clamp-1">{{ $gallery->title }}</h4>
                                        <p class="text-sm text-white/80 mt-1">{{ $gallery->created_at->format('d M Y') }}</p>
                                    </div>
                                </div>
                                {{-- Zoom Icon --}}
                                <div
