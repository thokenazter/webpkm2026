...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <a href="{{ route('pkm-admin.categories.create') }}" class="btn btn-primary">
                        ...
                        <tr class="hover:bg-neutral-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('pkm-admin.categories.edit', $category) }}" 
                                    ...
                                    @if($category->posts_count == 0 && $category->galleries_count == 0)
                                        <form action="{{ route('pkm-admin.categories.destroy', $category) }}" method="POST" class="inline"
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="text-neutral-500">
                                    ...
                                    <a href="{{ route('pkm-admin.categories.create') }}" class="text-primary-600 hover:text-primary-700">
