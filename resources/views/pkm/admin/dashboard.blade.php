        ...
        <div class="card">
            <div class="p-6 border-b border-neutral-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('pkm-admin.posts.index') }}" class="text-sm text-primary-600 hover:text-primary-700">
                        Lihat Semua
                    </a>
                </div>
            </div>
            <div class="divide-y divide-neutral-100">
                ...
                @empty
                    <div class="p-8 text-center text-neutral-500">
                        ...
                        <a href="{{ route('pkm-admin.posts.create') }}"
        ...
        <div class="card">
            <div class="p-6 border-b border-neutral-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('pkm-admin.galleries.index') }}" class="text-sm text-primary-600 hover:text-primary-700">
                        Lihat Semua
                    </a>
                </div>
            </div>
            <div class="p-4">
                ...
                @else
                    <div class="py-8 text-center text-neutral-500">
                        ...
                        <a href="{{ route('pkm-admin.galleries.create') }}"
                            class="text-sm text-primary-600 hover:text-primary-700 mt-2 inline-block">
                            Upload Foto Pertama
                        </a>
                    </div>
