...
@section('content')
    <div class="max-w-2xl">
        <form action="{{ route('pkm-admin.galleries.update', $gallery) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('pkm-admin.galleries.index') }}" class="btn border border-neutral-300 text-neutral-600 hover:bg-neutral-100">
                        Batal
                    </a>
                </div>
            </div>
