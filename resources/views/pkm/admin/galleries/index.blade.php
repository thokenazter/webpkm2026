...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <a href="{{ route('pkm-admin.galleries.create') }}" class="btn btn-primary">
                ...
                <div class="card overflow-hidden group">
                    <div class="aspect-square relative">
                        ...
                        <div
                            ...
                            <a href="{{ route('pkm-admin.galleries.edit', $gallery) }}"
                                class="p-2 bg-white rounded-lg text-neutral-700 hover:bg-primary-500 hover:text-white transition-colors">
                                <i data-lucide="edit" class="w-5 h-5"></i>
                            </a>
                            <form action="{{ route('pkm-admin.galleries.destroy', $gallery) }}" method="POST" class="inline"
