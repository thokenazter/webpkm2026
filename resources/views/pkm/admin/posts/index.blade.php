...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <a href="{{ route('pkm-admin.posts.create') }}" class="btn btn-primary">
                        ...
                        <tr class="hover:bg-neutral-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('pkm-admin.posts.edit', $post) }}" 
                                       class="p-2 text-neutral-600 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors"
                                       title="Edit">
                                        <i data-lucide="edit" class="w-4 h-4"></i>
                                    </a>
                                    <form action="{{ route('pkm-admin.posts.destroy', $post) }}" method="POST" class="inline" 
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="text-neutral-500">
                                    ...
                                    <a href="{{ route('pkm-admin.posts.create') }}" class="text-primary-600 hover:text-primary-700">
                                        Buat berita pertama
                                    </a>
                                </div>
                            </td>
